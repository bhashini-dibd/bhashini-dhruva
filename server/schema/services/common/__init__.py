...
from .ulca_txtlangdetection_inference_config import _ULCATxtLangDetectionInferenceConfig
from .ulca_lang_pair_multisuggetion import _ULCALangPairMultisuggestion
